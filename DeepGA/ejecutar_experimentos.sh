...
echo "============================================================================"
echo "  Rango de Semillas:        $START_SEED a $END_SEED"
...
for SEED in $(seq $START_SEED $END_SEED); do
    echo ""
    echo "============================================================================"
    echo "  [CICLO DE EXPERIMENTACIÓN] INICIANDO CON SEMILLA = $SEED"
    echo "============================================================================"
    ...
    for VAR in v1 v10 v11 v12; do
        ...
        echo ""
        echo "------------------------------------------------------------------------"
        echo "  [Corrida #$TOTAL_RUNS] Variante: $VAR | Semilla: $SEED | Execution: $SEED"
        echo "------------------------------------------------------------------------"
        ...
        if $PYTHON_CMD ejemplo_local.py \
            ...
            echo "[OK] Variante $VAR finalizada con éxito (Semilla: $SEED, Exec: $SEED)."
        else
            FAILED_RUNS=$((FAILED_RUNS + 1))
            echo "[ERROR] Falló la corrida de $VAR con Semilla $SEED."
        fi
    done
done
